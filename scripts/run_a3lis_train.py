...
from signclip.tasks.a3lis_train import trainA3LIS


def main():
    parser = argparse.ArgumentParser(description="A3LIS Scratch Training Launcher")
    parser.add_argument(
        "--config",
        type=str,
        default="configs/signclip_v1_1/a3lis_train.yaml",
    ...
    save_dir = config.fairseq.checkpoint.get("save_dir", "runs/a3lis_train")
    os.makedirs(save_dir, exist_ok=True)

    finetuner = trainA3LIS(config)
